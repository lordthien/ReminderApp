...
//        setContentView(R.layout.new_to_do_layout);
        ...
        if (cross != null) {
            ...
            FilterHelper.setColorFilter(cross,getResources().getColor(R.color.icons), FilterHelper.Mode.SRC_ATOP);
        }
    ...
    public void setReminderTextView() {
        if (mUserReminderDate != null) {
            ...
            if (mUserReminderDate.before(new Date())) {
                Log.d("NgocThien", "DATE is " + mUserReminderDate);
